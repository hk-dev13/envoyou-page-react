...
const ContactPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const apiUrls = [
                'https://api.envoyou.com/v1/contact',
                'http://localhost:10001/v1/contact',
                'http://localhost:10000/v1/contact'
            ];
                ...
                try {
                    response = await fetch(url, {
                        ...
                        body: JSON.stringify({
                            ...
                            inquiry_type: formData.subject.toLowerCase().replace(' ', '_')
                        }),
                    });
                                    ...
                                    {submitStatus === 'error' && (
                                        <div className="bg-red-900 border border-red-700 rounded-lg p-4">
                                            <div className="flex items-center">
                                                ...
                                                <span className="text-red-400 text-sm">Failed to send message. Please try again or contact us directly at support@envoyou.com</span>
                                            </div>
                                        </div>
                                    )}
                                </form>
