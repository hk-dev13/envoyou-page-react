        ...
        <div className="bg-slate-800 rounded-lg p-8">
            ...
            <div className="space-y-6">
                ...
                <div>
                    ...
                    <div className="bg-slate-900 rounded p-4 font-mono text-sm">
                        <div className="text-slate-400"># Alternative method</div>
    ...
    <div className="bg-slate-900 rounded-lg p-6">
        <div className="flex items-start justify-between mb-3">
            <div className="flex items-center space-x-3">
                ...
                <code className="text-emerald-400 font-mono">{path}</code>
            </div>
            ...
            <div className="space-y-8">
                <div>
                    ...
                    <div className="bg-slate-900 rounded p-4 font-mono text-sm overflow-x-auto">
                        ...
                        curl -H "Authorization: Bearer demo_key_premium_2025" \<br />
                ...
                <div>
                    ...
                    <div className="bg-slate-900 rounded p-4 font-mono text-sm overflow-x-auto">
                        ...
                        const response = await fetch('/global/cevs/Company%20Name', &#123;<br />
                        &nbsp;&nbsp;headers: &#123;<br />
                        &nbsp;&nbsp;&nbsp;&nbsp;'Authorization': 'Bearer demo_key_premium_2025'<br />
                        &nbsp;&nbsp;&#125;<br />
                        &#125;);<br />
                ...
                <div>
                    ...
                    <div className="bg-slate-900 rounded p-4 font-mono text-sm overflow-x-auto">
                        ...
                        headers = &#123;'Authorization': 'Bearer demo_key_premium_2025'&#125;<br />
                        response = requests.get(<br />
                        &nbsp;&nbsp;'https://api.envoyou.com/global/cevs/Company%20Name',<br />
                        &nbsp;&nbsp;headers=headers<br />
                        )<br />
                        data = response.json()
                    </div>
            ...
            <div className="space-y-6">
                <div>
                    ...
                    <div className="bg-slate-900 rounded p-4">
                        <div className="text-red-400 font-mono text-sm mb-2">Status: 401</div>
  ...
  "demo_keys": {
    ...
    "premium": "demo_key_premium_2025"
                ...
                <div>
                    ...
                    <div className="bg-slate-900 rounded p-4">
                        <div className="text-red-400 font-mono text-sm mb-2">Status: 429</div>
                        <pre className="text-slate-300 text-sm">{
`{
  "status": "error",
  ...
  "retry_after": 3600
                ...
                <div>
                    ...
                    <div className="bg-slate-900 rounded p-4">
                        <div className="text-red-400 font-mono text-sm mb-2">Status: 404</div>
                        <pre className="text-slate-300 text-sm">{
`{
  "status": "error",
  ...
  "code": "DATA_NOT_FOUND"
                ...
                <div>
                    ...
                    <div className="bg-slate-900 rounded p-4">
                        <div className="text-red-400 font-mono text-sm mb-2">Status: 400</div>
                        <pre className="text-slate-300 text-sm">{
`{
  "status": "error",
